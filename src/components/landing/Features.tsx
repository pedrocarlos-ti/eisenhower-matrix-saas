  ...
  const features = [
    {
      ...
      description: 'Easily categorize tasks based on urgency and importance with our drag-and-drop interface.'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Set due dates, reminders, and track time spent on tasks to improve your productivity.'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Gain valuable insights into your productivity patterns with detailed analytics and reports.'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
